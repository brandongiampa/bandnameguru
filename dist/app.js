...
/* harmony import */ var _js_hideNavbar_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/hideNavbar.js */ "./src/js/hideNavbar.js");
...
function onLoad() {
  ...
  if (document.getElementById("close-nav")) {
    document.getElementById("close-nav").addEventListener("click", onCloseNavClick);
  }

  if (document.getElementById("blackout-screen")) {
    document.getElementById("blackout-screen").addEventListener("click", onCloseNavClick);
  }
  ...
  if (document.getElementsByClassName("close-social")) {
...
function onMenuClick() {
  ...
  Object(_js_coverScreen_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_js_showNavbar_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
function onCloseNavClick() {
  ...
  Object(_js_hideNavbar_js__WEBPACK_IMPORTED_MODULE_0__["default"])();
  Object(_js_showScreen_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
  document.getElementById('show-menu').style.opacity = "100%";
}
...
/***/ "./src/js/closeAllSocialShareDivs.js":
/*!*******************************************!*\
  !*** ./src/js/closeAllSocialShareDivs.js ***!
  \*******************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
function closeAllSocialShareDivs() {
  //close all divs 
  var divs = document.getElementsByClassName("social-shares");
...
/* harmony default export */ __webpack_exports__["default"] = (closeAllSocialShareDivs);

/***/ }),

/***/ "./src/js/coverScreen.js":
/*!*******************************!*\
  !*** ./src/js/coverScreen.js ***!
  \*******************************/
/*! exports provided: default */
...
function coverScreen() {
  ...
  if (blackout) {
    ...
    setTimeout(function () {
      blackout.style.opacity = ".96";
    }, 0);
  }
}

/* harmony default export */ __webpack_exports__["default"] = (coverScreen);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
function getTransitionTimeInMs(element) {
  if (element) {
    //get computed style of element input 
    var style = getComputedStyle(element); //get transition time of element

    var str = style.transitionDuration; //remove "s" from string and split at decimal 

    var substr = str.substring(0, str.length - 1);
    var spl = substr.split("."); //get millisecond  value before decimal

    var thou = parseInt(spl[0]) * 1000;
    var hund = undefined !== spl[1] ? parseInt(spl[1]) * 100 : 0;
    var output = thou + hund;
    return output;
  } else {
    return 0;
  }
...
/* harmony default export */ __webpack_exports__["default"] = (getTransitionTimeInMs);
...
/* harmony default export */ __webpack_exports__["default"] = (hideNavbar);
...
function setBandNames() {
  ...
  axios.get('api/controller/bandnames.php?genre=' + genre).then(function (response) {
    //set proper guru name 
    if (document.getElementById("guru-name")) {
      document.getElementById("guru-name").innerText = "The Guru of " + genre.charAt(0).toUpperCase() + genre.slice(1);
    } // retrieve band names


    var obj = response.data.data; //create array to use band names dynamically

    var bandNames = [];
    bandNames.push(obj.band_name_1);
    bandNames.push(obj.band_name_2);
...
function showDotPulse() {
  if (document.getElementById("pulse-wrap")) {
    document.getElementById("pulse-wrap").style.visibility = "visible";
  }
}

function hideDotPulse() {
  if (document.getElementById("pulse-wrap")) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
function setTwitterHrefs() {
  var bandNameArray = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  //get current url 
  var url = window.location.href;
  console.log(url); //get metas 

  var hashtags = "BandNameGuru,BandNameGenerator,BandNameMaker,NameMyBand"; // get anchors

  var anchors = document.querySelectorAll("a.share-link-twitter"); //default text in case of error

  var defaultText = "Your band's name is almost as important as your band's music. While you work hard on the songs, let the Guru of Rock do the naming for you.";

  for (var i = 0; i < anchors.length; i++) {
    var text = null === bandNameArray ? defaultText : bandNameArray[i].toUpperCase() + " is the name the Guru hath bequeathed unto me.";
    text = replaceSpaces(text);
    var href = "https://twitter.com/share?url=".concat(url, "&text=").concat(text, "&hashtags=").concat(hashtags);
    anchors[i].href = href;
  }
}

function replaceSpaces(str) {
  //turns whitespaces into %20 for consistent url
  var arr = str.split(" ");
  return arr.join("%20");
}

/* harmony default export */ __webpack_exports__["default"] = (setTwitterHrefs);
...
/* harmony default export */ __webpack_exports__["default"] = (showNavbar);

/***/ }),

/***/ "./src/js/showScreen.js":
/*!******************************!*\
  !*** ./src/js/showScreen.js ***!
  \******************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _closeAllSocialShareDivs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./closeAllSocialShareDivs.js */ "./src/js/closeAllSocialShareDivs.js");


function toggleSocialShares(e) {
  //find div
  var shareButtons = e.target.parentElement.parentElement.lastChild.previousSibling; //get height to determine if open and create boolean

  var height = window.getComputedStyle(shareButtons).height;
  var isClosed = height === "0px"; //make sure all are closed so before the click target opens

  Object(_closeAllSocialShareDivs_js__WEBPACK_IMPORTED_MODULE_0__["default"])(); //set height if was closed when clicked

  if (isClosed) {
    shareButtons.style.height = "auto";
  }
}

/* harmony default export */ __webpack_exports__["default"] = (toggleSocialShares);
...
__webpack_require__(/*! C:\xampp\htdocs\bandnameguru\src\app.js */"./src/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\bandnameguru\src\app.scss */"./src/app.scss");
