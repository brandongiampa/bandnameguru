...
<section class="info-page terms-of-service">
        <div class="container">
                ...
                <ol class="main">
                        <li><!--Item 1-->
                                <h2>Agreement to Terms</h2><!--Header 1--> 
                                <ol>
                                        <li><!--SubItem 1.1-->
                                                These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (you), and Band Name Guru of Anaheim, California, USA (we, us), concerning your access to and use of the Band Name Guru (<a href="https://bandnameguru.com">https://bandnameguru.com</a>) website as well as any related applications (the Site).
                                        ...
                                        <li><!--SubItem 1.5-->
                                                Our site is directed to people residing in the United States. The information provided on the Site is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country.
                                        </li><!--End SubItem 1.5-->
                                        <li><!--SubItem 1.6-->
                        ...
                        <li><!--Item 4--> 
                                <h2>Link to third party content</h2>
                                <ol>
                                        <li><!--Item 4.1-->
                        ...
                        <li><!--Item 6-->
                                <h2>Modifications to and availability of the Site</h2>
                                <ol>
                                        <li>
                        ...
                        <li><!--Item 8-->
                                ...
                                <ol>
                                        <li>
                                        These Terms and Conditions shall remain in full force and effect while you use the Site or Services or are otherwise a user of the Site, as applicable. You may terminate your use or participation at any time, for any reason, by following the instructions for terminating user accounts in your account settings, if available, or by contacting us at <a href="mailto:me@brandongiampa.com">me@brandongiampa.com</a>.
                                        </li>
                                        <li>
                        ...
                        <li><!--Item 9-->
                                ...
                                <ol>
                                        ...
                                        <li>
                                        In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us by email at <a href="mailto:me@brandongiampa.com">me@brandongiampa.com</a>.        
                                        </li>
                                </ol>
                        </li><!--End Item 9-->
                </ol>
