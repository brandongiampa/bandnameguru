...
<section class="info-page privacy-policy">
    <div class="container">
        <h1>PRIVACY NOTICE</h1>

        <small>Last updated November 30, 2020</small>

        <p>
                Thank you for choosing to be part of our community at Band Name Guru ("Company", "we", "us", "our"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at <a href="mailto:me@brandongiampa.com">me@brandongiampa.com</a>.</p>
        </p>When you visit our website <a href="https://brandnameguru.com">https://bandnameguru.com</a> (the "Website"), and more generally, use any of our services (the "Services", which include the Website), we appreciate that you are trusting us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately.
        ...
        <ol class="table-of-contents">
            <li> <a href="#item-1">WHAT INFORMATION DO WE COLLECT?</a> </li>
            <li> <a href="#item-2">HOW DO WE USE YOUR INFORMATION?</a> </li>
            <li> <a href="#item-3">WILL YOUR INFORMATION BE SHARED WITH ANYONE?</a> </li>
            <li> <a href="#item-4">IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</a> </li>
            <li> <a href="#item-5">WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</a> </li>
            <li> <a href="#item-6">HOW LONG DO WE KEEP YOUR INFORMATION?</a> </li>
            <li> <a href="#item-7">HOW DO WE KEEP YOUR INFORMATION SAFE?</a> </li>
            <li> <a href="#item-8">WHAT ARE YOUR PRIVACY RIGHTS?</a> </li>
            <li> <a href="#item-9">CONTROLS FOR DO-NOT-TRACK FEATURES</a> </li>
            <li> <a href="#item-10">DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a> </li>
            <li> <a href="#item-11">DO WE MAKE UPDATES TO THIS NOTICE?</a> </li>
            <li> <a href="#item-12">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a> </li>
            <li> <a href="#item-13">HOW CAN YOU REVIEW, UPDATE OR DELETE THE DATA WE COLLECT FROM YOU?</a> </li>
        </ol>
        ...
        <ol class="contents">
            ...
            <li id="item-4"><!--item 4-->
                ...
                <p>Our servers are external. Please be aware that your information may be transferred to, stored, and processed by us in our facilities and by those third parties with whom we may share your personal information (see "WILL YOUR INFORMATION BE SHARED WITH ANYONE?" above), in and other countries.</p>
            ...
            <li id="item-12"><!--Item 12-->
                <h3>HOW CAN YOU CONTACT US ABOUT THIS NOTICE? </h3>
                <p>If you have questions or comments about this notice, you may email us at <a href="mailto:me@brandongiampa.com">me@brandongiampa.com</a> or by post to:</p>
            </li><!--End Item 12-->
            <li id="item-13"><!--Item 13-->
        ...
        <div class="info-footer">This privacy policy was created using Termly’s Privacy Policy Generator.</div>
    </div>
</section>
